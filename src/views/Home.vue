      ...
      <main>
        <article>
          ...
          <p>
            ...
            lived here my entire life. I'm excited to see Oklahoma develop a
            robust technology industry, while maintaining its rural beauty and
            historic landmarks.
          </p>
          <p>
        ...
        <aside>
          <div class="profile-pic">
            <img
              ...
              title="An entirely-too-handsome, red-bearded genius."
              alt="An entirely-too-handsome, red-bearded genius."
            />
            <div class="aside-title">Bio</div>
            <ul>
              <li>Born in 1990</li>
              <li>AAS, 2011</li>
              <li>BS, 2021</li>
              <li>Fulltime LAMP-Stack developer since 2015</li>
              <li>Top 5% in PHP on LinkedIn</li>
              <li>Top 5% in CSS on LinkedIn</li>
              <li>Top 5% in JQuery on LinkedIn</li>
            </ul>
          </div>
        </aside>
      </main>
